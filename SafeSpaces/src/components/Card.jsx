...
function Card() {
  ...
  const handleClick = (type) => {
    setMessage(`You have registered for the ${type} call option please wait........`);
    setTimeout(() => {
      setMessage('');
      ...
      <div className='card-container'>
        <div className='card'>
          <div className='card-content'>
            ...
            <i className="fa-solid fa-phone" onClick={() => handleClick('Police')}></i>
          </div>
        ...
        <div className='card'>
          <div className='card-content'>
            ...
            <i className="fa-solid fa-phone" onClick={() => handleClick('Fire')}></i>
          </div>
        ...
        <div className='card'>
          <div className='card-content'>
            ...
            <i className="fa-solid fa-phone" onClick={() => handleClick('Medical')}></i>
          </div>
        ...
        <div className='card'>
          <div className='card-content'>
            ...
            <i className="fa-solid fa-phone" onClick={() => handleClick('Disaster')}></i>
          </div>
        ...
        <div className='card'>
          <div className='card-content'>
            ...
            <i className="fa-solid fa-phone" onClick={() => handleClick('Women')}></i>
          </div>
        ...
        <div className='card'>
          <div className='card-content'>
            ...
            <i className="fa-solid fa-phone" onClick={() => handleClick('Child')}></i>
          </div>
        ...
        <div className='card'>
          <div className='card-content'>
            ...
            <i className="fa-solid fa-phone" onClick={() => handleClick('Railway')}></i>
          </div>
        ...
        <div className='card'>
          <div className='card-content'>
            ...
            <i className="fa-solid fa-phone" onClick={() => handleClick('Others')}></i>
          </div>
